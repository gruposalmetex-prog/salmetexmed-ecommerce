          ...
          <div className="flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-700">
                La variante se agregó correctamente al
                producto.
              </p>
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Cada variante representa una presentación,
              modelo o configuración disponible.
            </p>
          </div>
          ...
          {variants.length > 0 ? (
            ...
            <div className="mt-6 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-6 text-center">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Registra la primera presentación de este
                producto utilizando el formulario.
              </p>
            </div>
          )}
        </section>
        ...
        <div>
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Los cambios se guardarán en el borrador del
              producto.
            </p>
          </div>
