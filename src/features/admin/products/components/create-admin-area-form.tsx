...
import {
  createAdminAreaAction,
  type CreateAdminAreaState,
} from "../actions/create-admin-area.action";

const initialState: CreateAdminAreaState = {
  status: "idle",
};
...
export function CreateAdminAreaForm() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Define cómo se identificará el área dentro del
              catálogo médico.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-slate-500">
              Se utilizará en la dirección pública del área.
            </p>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              maxLength={320}
              disabled={pending}
              placeholder="Resumen breve del área y los equipos que incluye."
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              rows={6}
              disabled={pending}
              placeholder="Describe detalladamente el área."
              className="mt-2 w-full resize-y rounded-xl border border-slate-300 bg-white px-3 py-3 text-sm text-slate-900 outline-none transition focus:border-sky-600 focus:ring-4 focus:ring-sky-600/10 disabled:bg-slate-100"
            />
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm leading-6 text-slate-500">
          Estos campos son opcionales y ayudan a presentar el
          área en los buscadores.
        </p>
